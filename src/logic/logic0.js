...
case 28002:
ifSkip = ifSkipArrayShift();
          if (((cmd_controller(c22) || cmd_controller(c4) || cmd_said(15, 14))) || ifSkip) {
switch (jumptoLineArrayShift()) {
default:
            cmd_set(13);
            cmd_status();
case 280000:
ifSkip = ifSkipArrayShift();
            if ((cmd_greatern(25, 0) && !cmd_equaln(25, 255)) || ifSkip) {
switch (jumptoLineArrayShift()) {
default:
              cmd_assignv(255, 25);
              cmd_addn(255, 219);
...
case 2707:
        ...
        if (!cmd_isset(151) && cmd_has(i12) && cmd_has(i14) && cmd_has(i16) && cmd_has(i19) && cmd_has(i18)) {
          cmd_set(151);
          cmd_print(m40);
          cmd_print(m41);
          cmd_print(m42);
...
case 28000:
ifSkip = ifSkipArrayShift();
          if ((cmd_has(i12) && cmd_has(i14) && cmd_has(i16) && cmd_has(i19) && cmd_has(i18)) || ifSkip) {
switch (jumptoLineArrayShift()) {
default:
            cmd_program_control();
            cmd_prevent_input();
...
case 2805:
ifSkip = ifSkipArrayShift();
        if (((cmd_said(20, 21) || cmd_said(22, 23) || cmd_said(22, 24, 23) || cmd_said(22, 24, 25, 23) || cmd_said(26, 23) || cmd_said(26, 24, 23) || cmd_said(26, 24, 25, 23))) || ifSkip) {
switch (jumptoLineArrayShift()) {
default:
case 28000:
ifSkip = ifSkipArrayShift();
