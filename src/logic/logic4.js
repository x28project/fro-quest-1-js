  ...
  logic: while (1) {
    ...
    logicSwitch: switch (jumptoLine) {
      ...
      case 2836:
        ...
        if (
          (cmd_isset(124) &&
            (cmd_said(50, 55, 19, 66) || cmd_said(50, 19, 66))) ||
          ifSkip
        ) {
          switch (jumptoLineArrayShift()) {
            default:
