...
case 28001:
      ...
      case 4:
        if (!((cmd_said(42, 43, 29) || cmd_said(42, 43, 30) || cmd_said(42, 29, 43) || cmd_said(42, 30, 43)))) {
          jumpTo(508);
          break logicSwitch;
        }
        if (!(cmd_has(i6))) {
