...
case 2852:
ifSkip = ifSkipArrayShift();
        if (((cmd_said(50, 35, 58) || cmd_said(50, 35, 19, 58) || cmd_said(101, 35, 19, 58))) || ifSkip) {
switch (jumptoLineArrayShift()) {
default:
case 28000:
ifSkip = ifSkipArrayShift();
