...
case 28000:
ifSkip = ifSkipArrayShift();
          if ((cmd_isset(40) && !cmd_lessn(100, 1) && cmd_lessn(100, 50)) || ifSkip) {
switch (jumptoLineArrayShift()) {
default:
            cmd_increment(100);
            if (cmd_equaln(100, 3)) {
...
case 28001:
          ...
          if (cmd_isset(42) && !cmd_lessn(100, 101) && cmd_lessn(100, 200)) {
            cmd_increment(100);
          }
case 28002:
ifSkip = ifSkipArrayShift();
...
case 280000:
        ...
        if (!cmd_isset(40) && cmd_isset(42) && (cmd_have_key() || cmd_controller(c30))) {
          cmd_print(6);
...
default:
          ...
          if (cmd_isset(43) && !cmd_lessn(101, 101) && cmd_lessn(101, 200)) {
            cmd_increment(101);
          }
...
case 28000:
          if (cmd_isset(43) && !cmd_lessn(101, 201) && cmd_lessn(101, 250)) {
            cmd_increment(101);
          }
case 28001:
ifSkip = ifSkipArrayShift();
...
default:
            ...
            cmd_reset(15);
            cmd_assignn(21, 10);
            cmd_print_at("Art and Animation\n\n   X28 Project   ", 5, 20, 0);
...
case 280004:
      ...
      case 4:
        if (cmd_isset(46)) {
          if (!cmd_isset(47)) {
            cmd_set(47);
            cmd_print_at("To be continued in...\n\n\n    Fro Quest II     \n\n Shadows of Darkness \n", 8, 16, 0);
          }
          if (cmd_lessn(105, 60)) {
            cmd_increment(105);
            jumpTo(5);
      ...
      case 5:
        if (!cmd_isset(41) && cmd_isset(43) && (cmd_have_key() || cmd_controller(c30))) {
          cmd_print(14);
